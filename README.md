...
│
├── Data_Preprocessing_and_Exploration_Gouthami.ipynb      # Notebook 1: Data Cleaning & EDA
├── Regression_Modeling_Gouthami.ipynb                     # Notebook 2: Model Training & Hyperparameter Tuning
├── Model_Evaluation_and_Insights_Gouthami.ipynb           # Notebook 3: Final Evaluation, Insights & Error Analysis
│
├── final_fare_prediction_model.pkl                        # Saved Random Forest model (best model)
│
├── uber_dataset                                           # Original dataset (raw)
│
├── uber_processed_full.xls                                # Fully cleaned & processed dataset
├── X_train_processed.xls                                  # Processed training features
├── X_test_processed.xls                                   # Processed testing features
├── y_train.xls                                            # Target values for training
├── y_test.xls                                             # Target values for testing
│
├── model_predictions.xls                                  # Predictions generated by the final model
│
